...
var requiredJsonString = function(field) {
  return function(object) {
    var v = bind22(lookup(field)(object))(toString4);
    if (v instanceof Nothing) {
...
var bridgeOutcome = function(result) {
  ...
  ;
  var v = bind13(jsonParser(result.stdout))(decodeBridge);
  if (v instanceof Left) {
...
var runNickelLoaded = function(context) {
  return function(operation) {
    return function __do3() {
      ...
      var workflowSource = readUtf8(workflow)();
...
var runParsed = function(captureOutput) {
  return function(parsed) {
    return function(runner) {
      if (parsed instanceof Left) {
        return pure9(failureResult(parsed.value0.code)(parsed.value0.message));
      }
      ;
      if (parsed instanceof Right) {
...
var runVcsRead = function(request) {
  ...
  if (v instanceof Left) {
    return pure9(failureResult(1)(v.value0));
  }
  ;
  if (v instanceof Right) {
...
var runWorkflow = function(request) {
  ...
  if ($64) {
    return pure9(failureResult(1)("workflow: from is only valid with cli_seed"));
  }
  ;
...
var runAgencyDriver = function(request) {
  ...
  if (v instanceof Nothing) {
    return pure9(failureResult(1)(agencyDriverUsage));
  }
  ;
  if (v instanceof Just) {
    ...
    ;
    if (elem7(v.value0.head)(resultsOperationNames)) {
      return dispatchResults(v.value0.head)(v.value0.tail);
    }
    ;
    if (elem7(v.value0.head)(driverOperationNames)) {
...
var runTool = function(request) {
  ...
  ;
  return pure9(failureResult(1)("agency: unknown tool '" + (request.tool + "'")));
};
export {
  runTool
};
