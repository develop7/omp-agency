  ...
  return function(outcome) {
    return function __do4() {
      ...
      if (existing instanceof Left) {
        return append2(outcome)(failText3("sync: unable to read state while recording failure: " + existing.value0));
      }
      ;
      ...
      if (existing instanceof Right && existing.value0 instanceof Just) {
        ...
        if (written instanceof Left) {
          return append2(outcome)(failText3("sync: unable to mark workflow as failed: " + message2(written.value0)));
        }
        ;
