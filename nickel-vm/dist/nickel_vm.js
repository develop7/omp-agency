 ...
 * @returns {any}
 */
function eval_workflow(req) {
    const ret = wasm.eval_workflow(req);
    return ret;
}
exports.eval_workflow = eval_workflow;
...
const wasmPath = `${__dirname}/nickel_vm_bg.wasm`;
